...
Project leaders are responsible for clarifying and enforcing standards of
...
For conduct visible on GitHub, use GitHub's report or block controls and notify
a repository maintainer. For a confidential report, use
[inochi.srl](https://inochi.srl/) only to request a verified Pagelea community
conduct contact; do not include sensitive details until a private channel is
confirmed.
